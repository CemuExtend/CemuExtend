...
int main()
{
	...
	// permissions: suppressing that prompt is the point of disabling it. Being
	// disabled for a different title leaves the prompt in place.
	backend.cemodManagerSnapshot.packages[0].enabled = false;
	assert(controller.GetCemodLaunchPreflight(0x1234).pendingApprovals.empty());
