...
namespace WebFrontend
{
	...
	[[nodiscard]] constexpr std::uint16_t WindowsConsumerUsbHidUsage(std::uint32_t virtualKey)
	{
		...
		case 0xad:
			return 0x00e2; // mute
		case 0xae:
			return 0x00ea; // volume down
		case 0xaf:
			return 0x00e9; // volume up
		case 0xb0:
	...
	[[nodiscard]] constexpr std::uint16_t XkbConsumerUsbHidUsage(std::uint32_t key)
	{
		...
		{
		case 0x1008ff11:
			return 0x00ea; // XF86AudioLowerVolume
		case 0x1008ff12:
			return 0x00e2; // XF86AudioMute
		case 0x1008ff13:
			return 0x00e9; // XF86AudioRaiseVolume
		case 0x1008ff14:
			return 0x00cd; // XF86AudioPlay
		case 0x1008ff15:
			return 0x00b7; // XF86AudioStop
		case 0x1008ff16:
			return 0x00b6; // XF86AudioPrev
		case 0x1008ff17:
			return 0x00b5; // XF86AudioNext
		default:
			return 0;
		}
	}
