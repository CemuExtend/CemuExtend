...
class PortInfo : public ServerMessage
{
  public:
	...
	[[nodiscard]] const PortInfoData& GetInfo() const
	{
		return m_info;
	}
	...
	[[nodiscard]] DsState GetState() const
	{
		return m_info.state;
	}
	[[nodiscard]] DsModel GetModel() const
	{
		return m_info.model;
	}
	[[nodiscard]] DsConnection GetConnection() const
	{
		return m_info.connection;
	}
	[[nodiscard]] MACAddress_t GetMacAddress() const
	{
		return m_info.mac_address;
	}
	[[nodiscard]] DsBattery GetBattery() const
	{
		return m_info.battery;
	}
	[[nodiscard]] bool IsActive() const
	{
		return m_info.is_active != 0;
	}
...
class DataResponse : public PortInfo
{
  public:
	...
	[[nodiscard]] const DataResponseData& GetData() const
	{
		return m_data;
	}
	...
	{
		return m_data.m_packet_index;
	}
	uint8_t GetState1() const
	{
		return m_data.state1;
	}
	uint8_t GetState2() const
	{
		return m_data.state2;
	}
	uint8_t GetPs() const
	{
		return m_data.ps;
	}
	uint8_t GetTouch() const
	{
		return m_data.touch;
	}
	uint8_t GetLx() const
	...
	uint8_t GetDpadLeft() const
	{
		return m_data.dpad_left;
	}
	uint8_t GetDpadDown() const
	{
		return m_data.dpad_down;
	}
	uint8_t GetDpadRight() const
	{
		return m_data.dpad_right;
	}
	uint8_t GetDpadUp() const
	{
		return m_data.dpad_up;
	}
	uint8_t GetSquare() const
	{
		return m_data.square;
	}
	uint8_t GetCross() const
	{
		return m_data.cross;
	}
	uint8_t GetCircle() const
	{
		return m_data.circle;
	}
	uint8_t GetTriangle() const
	{
	...
	const TouchPoint& GetTpad1() const
	{
		return m_data.tpad1;
	}
	const TouchPoint& GetTpad2() const
	{
		return m_data.tpad2;
	}
	uint64_t GetMotionTimestamp() const
	{
		return m_data.motion_timestamp;
	}
