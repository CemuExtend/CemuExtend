...
namespace
{
								 ...
								 public Input::IControllerStateObserver
	{
	  public:
		...
		fs::path GetCachePath(std::string_view relativePath) const override
		{
...
namespace
{
							...
							std::optional<Application::WindowTitlePresentation> presentation)
	{
		...
		if (presentation)
		{
			...
			{
			case Application::PresentationGpuVendor::Amd:
				graphicMode = "[AMD GPU]";
				break;
			case Application::PresentationGpuVendor::Intel:
