...
namespace
{
	...
	{
		if (key >= 'A' && key <= 'Z') return static_cast<uint16>(0x04 + key - 'A');
		if (key >= 'a' && key <= 'z') return static_cast<uint16>(0x04 + key - 'a');
		if (key >= '1' && key <= '9') return static_cast<uint16>(0x1e + key - '1');
		if (key == '0') return 0x27;
		if (key >= WXK_F1 && key <= WXK_F12) return static_cast<uint16>(0x3a + key - WXK_F1);
		if (key >= WXK_F13 && key <= WXK_F24) return static_cast<uint16>(0x68 + key - WXK_F13);
		switch (key)
		{
		case WXK_RETURN: return 0x28; case WXK_ESCAPE: return 0x29;
		case WXK_BACK: return 0x2a; case WXK_TAB: return 0x2b; case WXK_SPACE: return 0x2c;
		...
		case '.': return 0x37; case '/': return 0x38; case WXK_CAPITAL: return 0x39;
		case WXK_PRINT: case WXK_SNAPSHOT: return 0x46; case WXK_SCROLL: return 0x47;
		case WXK_PAUSE: return 0x48; case WXK_INSERT: return 0x49; case WXK_HOME: return 0x4a;
		case WXK_PAGEUP: return 0x4b; case WXK_DELETE: return 0x4c; case WXK_END: return 0x4d;
		case WXK_PAGEDOWN: return 0x4e; case WXK_RIGHT: return 0x4f; case WXK_LEFT: return 0x50;
		case WXK_DOWN: return 0x51; case WXK_UP: return 0x52; case WXK_NUMLOCK: return 0x53;
		case WXK_DIVIDE: case WXK_NUMPAD_DIVIDE: return 0x54;
		case WXK_MULTIPLY: case WXK_NUMPAD_MULTIPLY: return 0x55;
		case WXK_SUBTRACT: case WXK_NUMPAD_SUBTRACT: return 0x56;
		case WXK_ADD: case WXK_NUMPAD_ADD: return 0x57; case WXK_NUMPAD_ENTER: return 0x58;
		case WXK_NUMPAD_SPACE: return 0x2c; case WXK_NUMPAD_TAB: return 0x2b;
		case WXK_NUMPAD_F1: return 0x3a; case WXK_NUMPAD_F2: return 0x3b;
		case WXK_NUMPAD_F3: return 0x3c; case WXK_NUMPAD_F4: return 0x3d;
		case WXK_NUMPAD1: return 0x59; case WXK_NUMPAD2: return 0x5a; case WXK_NUMPAD3: return 0x5b;
		case WXK_NUMPAD4: return 0x5c; case WXK_NUMPAD5: return 0x5d; case WXK_NUMPAD6: return 0x5e;
		case WXK_NUMPAD7: return 0x5f; case WXK_NUMPAD8: return 0x60; case WXK_NUMPAD9: return 0x61;
		case WXK_NUMPAD0: return 0x62; case WXK_DECIMAL: case WXK_NUMPAD_DECIMAL: return 0x63;
		case WXK_NUMPAD_EQUAL: return 0x67; case WXK_SEPARATOR: case WXK_NUMPAD_SEPARATOR: return 0x85;
		case WXK_EXECUTE: return 0x74; case WXK_HELP: return 0x75; case WXK_SELECT: return 0x77;
		case WXK_CANCEL: return 0x9b; case WXK_CLEAR: return 0x9c;
		case WXK_MENU: case WXK_WINDOWS_MENU: return 0x65; default: return 0;
		}
	}
	...
	int HidToWxKey(uint16 usage)
	{
		...
		if (usage >= 0x3a && usage <= 0x45) return WXK_F1 + usage - 0x3a;
		if (usage >= 0x68 && usage <= 0x73) return WXK_F13 + usage - 0x68;
		switch (usage)
		{
		case 0x28: return WXK_RETURN; case 0x29: return WXK_ESCAPE; case 0x2a: return WXK_BACK;
		case 0x2b: return WXK_TAB; case 0x2c: return WXK_SPACE; case 0x2d: return '-';
		case 0x2e: return '='; case 0x2f: return '['; case 0x30: return ']'; case 0x31: return '\\';
		case 0x33: return ';'; case 0x34: return '\''; case 0x35: return '`'; case 0x36: return ',';
		case 0x37: return '.'; case 0x38: return '/'; case 0x39: return WXK_CAPITAL;
		case 0x46: return WXK_PRINT; case 0x47: return WXK_SCROLL; case 0x48: return WXK_PAUSE;
		case 0x49: return WXK_INSERT; case 0x4a: return WXK_HOME; case 0x4b: return WXK_PAGEUP;
		case 0x4c: return WXK_DELETE; case 0x4d: return WXK_END; case 0x4e: return WXK_PAGEDOWN;
		case 0x4f: return WXK_RIGHT; case 0x50: return WXK_LEFT; case 0x51: return WXK_DOWN;
		case 0x52: return WXK_UP; case 0x53: return WXK_NUMLOCK; case 0x54: return WXK_NUMPAD_DIVIDE;
		case 0x55: return WXK_NUMPAD_MULTIPLY; case 0x56: return WXK_NUMPAD_SUBTRACT;
		case 0x57: return WXK_NUMPAD_ADD; case 0x58: return WXK_NUMPAD_ENTER;
		case 0x59: return WXK_NUMPAD1; case 0x5a: return WXK_NUMPAD2; case 0x5b: return WXK_NUMPAD3;
		case 0x5c: return WXK_NUMPAD4; case 0x5d: return WXK_NUMPAD5; case 0x5e: return WXK_NUMPAD6;
		case 0x5f: return WXK_NUMPAD7; case 0x60: return WXK_NUMPAD8; case 0x61: return WXK_NUMPAD9;
		case 0x62: return WXK_NUMPAD0; case 0x63: return WXK_NUMPAD_DECIMAL;
		case 0x65: return WXK_MENU; default: return WXK_NONE;
		}
	}
	...
	{
		return {WxKeyToHid(binding.keyboard.key), static_cast<std::uint8_t>(
			(binding.keyboard.ctrl ? 1U : 0U) | (binding.keyboard.shift ? 2U : 0U) |
			(binding.keyboard.alt ? 4U : 0U)), binding.controller};
	}
}
