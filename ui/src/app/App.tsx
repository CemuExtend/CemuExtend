...
const fallback: Bootstrap = { windowRole: "main-library", appVersion: "development", platform: "unknown", theme: "system", shuttingDown: false };
...
export function App() {
  ...
  return bootstrap.windowRole === "main-library" ? <Library /> : <RoleWindow role={bootstrap.windowRole} />;
}
