...
export type PpcDebuggerInstruction = { address: GuestAddress; opcode: string; mnemonic: string; operands: string; current: boolean; breakpoint: boolean };
export type PpcDebuggerBreakpoint = { identity: string; address: GuestAddress; enabled: boolean; logging: boolean };
export type PpcDebuggerSnapshot = { generation: string; available: boolean; trapped: boolean; instructionPointer: GuestAddress; linkRegister: GuestAddress; gpr: GuestAddress[]; instructions: PpcDebuggerInstruction[]; breakpoints: PpcDebuggerBreakpoint[]; breakpointCapReached: boolean; diagnostic: string };
...
export type EmulatedUsbModel = { generation: string; emulatedDevices: EmulatedUsbDevice[]; attachedDevices: UsbDeviceDescriptor[] };
export type UsbDevicesChangedPayload = { generation: string; attached: boolean; device: UsbDeviceDescriptor };
