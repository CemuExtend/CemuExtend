...
export const previewInput: InputSettingsModel = {
  ...
  players: Array.from({ length: 4 }, (_, player) => ({
    player,
    type: player === 0 ? "gamePad" : player === 1 ? "proController" : "disabled",
    ...
    mappings: [
      ...
      { mappingId: 3, label: "Left Stick X", binding: "Axis 0", controllerToken: 1 },
...
export const previewPacks: GraphicPack[] = [
  {
    ...
    presets: [
      { category: "Resolution", name: "1920×1080", active: true, visible: true },
      { category: "Resolution", name: "3840×2160", active: false, visible: true },
      { category: "Shadow quality", name: "High", active: true, visible: true },
    ],
  },
  {
    key: "preview-long-pack-key-for-overflow-verification",
    virtualPath: "Universal/Enhancements/Extremely Long Pack Path For Overflow Checks",
    name: "Universal Enhancements With a Deliberately Long Display Name",
    description: "A long description that must wrap without pushing controls outside the window.",
    version: 1,
    universal: true,
    enabled: false,
    activated: false,
  ...
  titles: [
    {
      ...
      name: "Preview Adventure",
      saves: [
        { persistentId: "80000001", state: "directory", accountName: "Preview Player" },
        { persistentId: "80000002", state: "missing", accountName: "Long Secondary Account Name" },
      ],
    },
  ],
};
  ...
  packages: [
    {
      ...
      packageDigest: "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
      pluginName: "Preview CemuMod With a Long Package Name",
      author: "Preview Author",
      version: "1.2.3",
      description: "Representative exact-package permission data for complete visual verification.",
      scope: "title",
      status: "approved",
...
export const previewUsb: EmulatedUsbModel = {
  generation: "4",
  emulatedDevices: [
    { id: "skylanders", name: "Skylanders Portal", vendorId: 5168, productId: 336, enabled: true, connected: true },
    { id: "infinity", name: "Disney Infinity Base", vendorId: 3695, productId: 305, enabled: false, connected: false },
    { id: "dimensions", name: "LEGO Dimensions Toy Pad", vendorId: 3695, productId: 374, enabled: true, connected: true },
  ],
  attachedDevices: [
    { id: "usb-preview-device-with-long-identity", vendorId: 5168, productId: 336, interfaceIndex: 0, interfaceSubClass: 0, protocol: 0, maxPacketSizeRx: 64, maxPacketSizeTx: 64, opened: true },
  ],
};
...
export const previewThreads: PpcThreadsModel = {
  ...
  threads: Array.from({ length: 8 }, (_, index) => ({
    ...
    name: index === 0 ? "Main PPC thread with a deliberately long diagnostic name" : `Worker ${index}`,
    gpr: ["00000001", "00000002", "00000003", "00000004", "00000005"],
    cancelRequested: false,
    suspensionOwnedByFacade: index === 3,
    waitingMutex: index === 2 ? { address: "20000040", owner: "10010100", lockCount: 1 } : undefined,
...
export const previewTextures: TextureDiagnosticPage = {
  ...
  diagnostic: "",
  rows: [
    { id: "texture-1", kind: "texture", active: true, updatedOnGpu: true, depthFormat: false, dimension: "2D", format: "RGBA8_UNORM", width: 1920, height: 1080, depth: 1, pitch: 2048, tileMode: 4, firstSlice: 0, sliceCount: 1, firstMip: 0, mipCount: 10, ageMilliseconds: 12, alternativeViewCount: 1, resolutionOverridden: true, effectiveWidth: 3840, effectiveHeight: 2160, effectiveDepth: 1 },
    { id: "view-1", parentId: "texture-1", kind: "view", active: true, updatedOnGpu: false, depthFormat: false, dimension: "2D array view with long descriptor", format: "RGBA8_SRGB", width: 1920, height: 1080, depth: 1, pitch: 2048, tileMode: 4, firstSlice: 0, sliceCount: 1, firstMip: 0, mipCount: 1, ageMilliseconds: 0, alternativeViewCount: 0, resolutionOverridden: false, effectiveWidth: 1920, effectiveHeight: 1080, effectiveDepth: 1 },
    { id: "texture-2", kind: "texture", active: false, updatedOnGpu: false, depthFormat: true, dimension: "2D", format: "D24_S8", width: 1280, height: 720, depth: 1, pitch: 1280, tileMode: 2, firstSlice: 0, sliceCount: 1, firstMip: 0, mipCount: 1, ageMilliseconds: 241, alternativeViewCount: 0, resolutionOverridden: false, effectiveWidth: 1280, effectiveHeight: 720, effectiveDepth: 1 },
  ],
};
...
export const previewAudio: AudioVoiceDiagnosticPage = {
  ...
  rows: Array.from({ length: 12 }, (_, index) => ({
    ...
    deviceMix: index === 2 ? "TV L/R + GamePad L/R + long diagnostic route" : "TV L/R",
  })),
};
